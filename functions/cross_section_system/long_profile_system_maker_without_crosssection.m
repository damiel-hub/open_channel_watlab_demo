function [interp_x, interp_y, interp_R_x, interp_R_y, interp_L_x, interp_L_y, interp_s, interp_vertical_theta] = long_profile_system_maker_without_crosssection(ds, point_xy, point_L_xy, point_R_xy, pltFlag)
...
% See also: interp1, cumsum, atan2, plot, line_segment_intersect
    ...
    %%
    point_extent_x_y_s_alongtheta = [point_x point_y point_s point_along_theta];
    ...
    % --- NEW FIX: Unwrap angles before interpolation ---
    ...
    % --- NEW FIX: Interpolate the UNWRAPPED angles ---
