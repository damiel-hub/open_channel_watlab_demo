...
% Results folder path
result_png_folder = 'results/laonong_unsteady_narrow_20m_cfl05_hydrograph_steep/post_process_demo_wave_propagation';
...
%%
[interp_x, interp_y, interp_R_x, interp_R_y, interp_L_x, interp_L_y, interp_s, ~] = long_profile_system_maker_without_crosssection(distance_between_sections, central_xy, left_xy, right_xy, 0);
